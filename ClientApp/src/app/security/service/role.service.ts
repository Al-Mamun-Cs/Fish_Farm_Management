...
export class RoleService {
  ...
  update(id: any,model: any) {
    return this.http.put(this.baseUrl + '/role/update-role?roleId='+id, model);
  }
  submit(model: any) {
  ...
  getRoleFeatures(roleId){
    return this.http.get<SelectedModel[]>(this.baseUrl + '/RoleFeature/get-RoleFeaturesByRole?roleId='+roleId)
  }
  // assignFeature(id: any,model: any) {
  //   console.log(model);
  //   return this.http.put(this.baseUrl + '/RoleFeature/assign-RoleFeature?roleId=abc'+id, model);
  // }
  assignFeature(id:any, model: any) {
    return this.http.put(this.baseUrl + '/RoleFeature/assign-RoleFeature?roleId='+id, model);
  }
}
