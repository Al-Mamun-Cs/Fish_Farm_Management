...
@Component({
  ...
  templateUrl: './new-fisheriesinventory.component.html',
  styleUrls: ['./new-fisheriesinventory.component.sass']
})
export class NewFisheriesInventoryComponent implements OnInit {
  buttonText: string;
  pageTitle: string;
  destination: string;
  ...
  intitializeForm() {
    ...
    this.InventoryForm = this.fb.group({
      ...
      approveStatus: [false],
      isActive: [true],
      fisheriesInventoryDetail: this.fb.array([
  ...
  getSelectedSupplierName(supplierName) {
    this.FisheriesInventoryService.getSelectedSupplierName(supplierName, this.branchId).subscribe(response => {
  ...
  getSelectedProductTypeList() {
    this.FisheriesInventoryService.getSelectedProductTypeList(this.branchId).subscribe(res => {
      this.productTypeList = res;
    });
  }

  getSelectedUnitList() {
    this.FisheriesInventoryService.getSelectedUnitList().subscribe(res => {
      this.unitList = res;
    });
  }
  ...
  generateBillNo() {
    this.FisheriesInventoryService.getPurchaBillNo().subscribe(res => {
  ...
  get product() {
    return this.InventoryForm.get('fisheriesInventoryDetail') as FormArray
  }
  ...
  addProductDetails(event: Event): void {
    ...
    const control = <FormArray>this.InventoryForm.controls['fisheriesInventoryDetail'];
  ...
  getWarehouseList() {
    this.FisheriesInventoryService.getSelectedWarehousesList().subscribe(res => {
  ...
  onSubmit() {
    const id = this.InventoryForm.get('fisheriesInventoryId').value;
    ...
    if (id) {
      this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This Item?').subscribe(result => {
        console.log(result);
        if (result) {
          this.FisheriesInventoryService.update(+id, this.InventoryForm.value).subscribe(response => {
            this.router.navigateByUrl('/fishproduct-stock/fisheriesinventory-list');
      ...
      this.FisheriesInventoryService.submit(this.InventoryForm.value).subscribe(response => {
