...
@Component({
  selector: 'app-projectschedule-list',
  templateUrl: './projectschedule-list.component.html',
  styleUrls: ['./projectschedule-list.component.sass']
})
export class ProjectScheduleListComponent implements OnInit {
