...
@Component({
  selector: 'app-fisheriesinventoryout-list',
  templateUrl: './fisheriesinventoryout-list.component.html',
  styleUrls: ['./fisheriesinventoryout-list.component.sass']
})
export class FisheriesInventoryOutListComponent implements OnInit {
