...
@Component({
  selector: 'app-dailycostdetail-list',
  templateUrl: './dailycostdetail-list.component.html',
  styleUrls: ['./dailycostdetail-list.component.sass']
})
export class DailyCostDetailListComponent implements OnInit {
  ...
  getDailyCostDetailList() {
    this.isLoading = true;
    this.DashboardService.getDailyCostDetailList(this.branchId,).subscribe(response => {
