...
@Component({
  selector: 'app-fisheriesproducttypewisecoset-list',
  templateUrl: './fisheriesproducttypewisecoset-list.component.html',
  styleUrls: ['./fisheriesproducttypewisecoset-list.component.sass']
})
export class FisheriesProductTypewiseCosetListComponent implements OnInit {
