...
@Component({
  selector: 'app-shopproductstock-list',
  templateUrl: './shopproductstock-list.component.html',
  styleUrls: ['./shopproductstock-list.component.sass']
})
export class ShopProductStockListComponent implements OnInit {
  ...
  getShopProductStocks() {
    this.isLoading = true;
    this.DashboardService.getShopProductStockList(this.branchId, this.fisheriesProductTypeId).subscribe(response => {
      this.productStock = response;
      console.log(this.productStock, "Shop product Stock data")
      ...
      <html>
        ...
        <body onload="window.print();window.close()">
          ...
          <img src="assets/images/ITH_Logo.png" alt="BMU Logo" style="height: 60px; margin-bottom: 5px; display: block; margin-left: auto; margin-right: auto;" />
            <h4 style="margin:0;"> মোট মজুদের পরিমাণ </h4>
          </div>
          <br>
          <hr>
