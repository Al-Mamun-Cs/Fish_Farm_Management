...
@Component({
  selector: 'app-fisheriesproductstock-list',
  templateUrl: './fisheriesproductstock-list.component.html',
  styleUrls: ['./fisheriesproductstock-list.component.sass']
})
export class FisheriesProductStockListComponent implements OnInit {
      ...
      <html>
        ...
        <body onload="window.print();window.close()">
          ...
          <img src="assets/images/ITH_Logo.png" alt="BMU Logo" style="height: 60px; margin-bottom: 5px; display: block; margin-left: auto; margin-right: auto;" />
            <h4 style="margin:0;"> বর্তমান মজুদের পরিমাণ (কেজি/পিস)</h4>
          </div>
          <br>
          <hr>
