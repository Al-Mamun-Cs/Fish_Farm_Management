...
@Component({
  selector: 'app-cashinhanddetailcapitalsix-list',
  templateUrl: './cashinhanddetailcapitalsix-list.component.html',
  styleUrls: ['./cashinhanddetailcapitalsix-list.component.sass']
})
export class CashInHandDetailCapitalSixListComponent implements OnInit {
  ...
  getCashInHandDetail() {
    this.isLoading = true;
    this.DashboardService.getCashInHandDetail(39).subscribe(response => {
      this.cashInHandDetail = response;
      this.getGrandTotal();
      ...
      <html>
        ...
        <body onload="window.print();window.close()">
          ...
          <img src="assets/images/ITH_Logo.png" alt="BMU Logo" style="height: 60px; margin-bottom: 5px; display: block; margin-left: auto; margin-right: auto;" />
            <h4 style="margin:0;">হাতে নগদের বিবরণ</h4>
          </div>
          <br>
          <hr>
