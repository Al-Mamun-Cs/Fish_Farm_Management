...
@Component({
  selector: 'app-cashinhanddetail-list',
  templateUrl: './cashinhanddetail-list.component.html',
  styleUrls: ['./cashinhanddetail-list.component.sass']
})
export class CashInHandDetailListComponent implements OnInit {
  ...
  getCashInHandDetail() {
    this.isLoading = true;
    this.DashboardService.getCashInHandDetail(this.branchId,).subscribe(response => {
