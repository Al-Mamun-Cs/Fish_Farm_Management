...
{
    public class GetSelectedSupplierByWarehouseIdRequestHandler : IRequestHandler<GetSelectedSupplierByWarehouseIdRequest, List<SelectedModel>>
    {
        private readonly ISchoolManagementRepository<Supplier> _SupplierRepository;


        public GetSelectedSupplierByWarehouseIdRequestHandler(ISchoolManagementRepository<Supplier> SupplierRepository)
        {
            _SupplierRepository = SupplierRepository;
        }

        public async Task<List<SelectedModel>> Handle(GetSelectedSupplierByWarehouseIdRequest request, CancellationToken cancellationToken)
        {
